...
window.onload = function () {
    ...
    $(function () {
        $.ajax({
            url: "http://111.231.208.121:8080/ttms/api/v1/employee/select?employeeNo=" + account,
            type: "GET",
            xhrFields: {withCredentials: true},
            success: function (res) {
                console.log(res);
                ...
                let person2 = res.emp_name;
                $(".person").text(person2);

                $(function () {
                    $.ajax({
                        type: "GET",
                        url: "http://111.231.208.121:8080/ttms/api/v1/user/type?emp_no=" + res.emp_no,
                        xhrFields: {withCredentials: true},
...
function toolNavAppend(res) {
    $(".toolNav").append(
        ...
        + '<div class="TMToolChildNav">' + "座位管理" + '</div>'
        + '<div class="TMToolChild" style="display: none">' + "查询座位" + '</div>'
        + '<div class="TMToolChild" style="display: none">' + "添加座位" + '</div>'
        + '<div class="TMToolChildNav">' + "用户管理" + '</div>'
        + '<div class="TMToolChild" style="display: none">' + "查询用户" + '</div>'
        + '<div class="TMToolChild" style="display: none">' + "添加用户" + '</div>'
    );
...
function slide() {
    ...
    $(".TMToolChildNav").eq(3).click(function () {
        if ($(".TMToolChild").eq(6).css("display") == "none") {
            $(".TMToolChild").eq(6).slideDown("slow");
            $(".TMToolChild").eq(7).slideDown("slow");
        } else {
            $(".TMToolChild").eq(6).slideUp("slow");
            $(".TMToolChild").eq(7).slideUp("slow");
        }
    })
}
...
function addUser(i) {
    if (i == 0) {
        $(".choiceBody").eq(i).append(
            ...
            + '<button id="AddButton" onclick="addUserBtn()" >确认</button>'
            + '</span>'
            + '</div>'
            + '<div class="addUserBody">'

            + '<div class="addUserInput">'
            + '<p>用户姓名:</p>' + '<input id="inputName" type="text">' + '<br/>'
            + '</div>'
            + '<span class="ERName"><div class="ERhead"></div><div class="ERbody">姓名不符合</div></span>'

            + '<div class="addUserInput" id="accountInput">'
            + '<p>账号:</p>' + '<input id="inputAccount" type="text"  required >' + '<br/>'
            + '</div>'
            + '<span class="ERAccount"><div class="ERhead"></div><div class="ERbody">账号至少两种组合，小于六位</div> </span>'

            + '<div class="addUserInput">'
            + '<p>电话:</p>' + '<input type="tel" name="tel" id="tel" required >' + '<br/>'
            + '</div>'
            + '<span class="ERTel"><div class="ERhead"></div><div class="ERbody">这明显不是电话号码</div></span>'
...
//双向绑定表单信息
        let nameText = /^[\u4E00-\u9FA5]{2,10}$/;
        $('#inputName').bind('input propertychange', function () {
            if (!nameText.test($(this).val())) {
                $(".ERName").css("display", "block");
            } else {
                $(".ERName").css("display", "none");
                if ($(".ERAccount").css("display") == "none" && $(".ERTel").css("display") == "none") {
                    console.log(1);
        ...
        let accountText = /^(?![A-Z]+$)(?![a-z]+$)(?!\d+$)(?![\W_]+$)\S{1,6}$/;
        $('#inputAccount').bind('input propertychange', function () {

            if (!accountText.test($(this).val())) {
                $(".ERAccount").css("display", "block");

            } else {
                $(".ERAccount").css("display", "none");
                if ($(".ERName").css("display") == "none" && $(".ERTel").css("display") == "none") {
                    console.log(1);
                    $("#AddButton").attr("disabled", false);
                }
            }
        ...
        $('#tel').bind('input propertychange', function () {
            if (!mobilevalid.test($(this).val())) {
                $(".ERTel").css("display", "block");

            } else {
                $(".ERTel").css("display", "none");
                console.log($(".ERAccount").css("display"));
                if (($(".ERAccount").css("display") == "none") && ($(".ERName").css("display") == "none")) {
                    console.log(1);
                    $("#AddButton").attr("disabled", false);
                }
            }
...
//     let nameText = /^[\u4E00-\u9FA5]{2,10}$/;
//
//     if(!mobilevalid.test(tel)|!accountText.test(account)|!nameText.test(name)){
//         alert("不要忽视提示哦！");
//         return false;
//     }
//
//
//     $.ajax({
//         url: "http://47.93.98.212/User/CreateUser",
//         type: "POST",
//         contentType: "application/json; charset=utf-8",
//         xhrFields: {withCredentials: true},
//
...
//     $.ajax({
//         url: "http://47.93.98.212/User/QueryUserById/" + res.userId,
//         type: "GET",
//         contentType: "application/json; charset=utf-8",
//         xhrFields: {withCredentials: true},
...
//     if (id != "") {
//         $.ajax({
//             url: "http://47.93.98.212/User/QueryUserById/" + id,
//             type: "GET",
//             contentType: "application/json; charset=utf-8",
//             xhrFields: {withCredentials: true},
//             success: function (res) {
...
//     if (cfd == true) {
//         $.ajax({
//             url: "http://47.93.98.212/User/DeleteUser/" + id,
//             type: "DELETE",
//             xhrFields: {withCredentials: true},
//             success: function (res) {
//
...
//
//     $.ajax({
//         url: "http://47.93.98.212/Theater/CreateTheater",
//         type: "POST",
//         contentType: "application/json; charset=utf-8",
//         xhrFields: {withCredentials: true},
//         data: JSON.stringify(
...
//                     console.log($id);
//                     $.ajax({
//                         url: "http://47.93.98.212/Theater/QueryTheater/" + $id,
//                         type: "GET",
//                         contentType: "application/json; charset=utf-8",
//                         xhrFields: {withCredentials: true},
//                         success: function (res) {
...
//
//             $.ajax({
//                 url: "http://47.93.98.212/User/SelectUser/" + res.theaterId,
//                 type: "GET",
//                 contentType: "application/json; charset=utf-8",
//                 xhrFields: {withCredentials: true},
//                 success: function (rest) {
...
//     if (cfd == true) {
//         $.ajax({
//             url: "http://47.93.98.212/Theater/DeleteTheater/" + id,
//             type: "DELETE",
//             xhrFields: {withCredentials: true},
//             success: function (res) {
//
...
//
//         $.ajax({
//             url: "http://47.93.98.212/Programme/GetAllTags",
//             type: "GET",
//
//             xhrFields: {withCredentials: true},
//             success: function (res) {
...
//                 $.ajax({
//                     type: "GET",
//                     url: " http://47.93.98.212/Programme/QueryProgrammeByName/"+res.data[i].programmeName,
//                     xhrFields: {withCredentials: true},
//                     contentType: "application/json; charset=utf-8",
//                     dataType:"json",
//                     success: function (rest) {
...
//                         $.ajax({
//                             type: "GET",
//                             url: " http://47.93.98.212/Programme/SelectPlayBill/"+rest.data.programmeId,
//                             xhrFields: {withCredentials: true},
...
//                     $.ajax({
//                         url: "http://47.93.98.212/Programme/QueryProgrammeByName/" + $name,
//                         type: "GET",
//                         contentType: "application/json; charset=utf-8",
//                         xhrFields: {withCredentials: true},
//                         success: function (res) {
...
//         console.log(id);
//         $.ajax({
//             url: "http://47.93.98.212/Programme/DeleteProgramme/" + id,
//             type: "DELETE",
//             xhrFields: {withCredentials: true},
//             success: function (res) {
//                 console.log(res.msg);
...
//
//         $.ajax({
//             url: "http://47.93.98.212/Programme/SelectProgrammeBytags/" + $select,
//             type: "GET",
//             xhrFields: {withCredentials: true},
//             success: function (res) {
//                 $(".queryMovieBody").children().remove();
...
//     if ($select != "无选项" && $name == "" && $id != "") {
//         $.ajax({
//             url: "http://47.93.98.212/Programme/QueryProgrammeById/" + $id,
//             type: "GET",
//             xhrFields: {withCredentials: true},
//             success: function (res) {
//                 console.log(res.data);
...
//             $.ajax({
//                 type: "GET",
//                 url: " http://47.93.98.212/Programme/QueryProgrammeByName/" + data[i].programmeName,
//                 xhrFields: {withCredentials: true},
//                 success: function (res) {
//
...
//                         success: function (res) {
//
//                             let $src = "http://47.93.98.212/" + res.data;
//
//                             console.log($src);
//
//                             movie.eq(i).find("img").attr("src", $src);
...
//         $.ajax({
//             type: "POST",
//             url: "http://47.93.98.212/Programme/CreateProgramme" ,
//             contentType: "application/json; charset=utf-8",
//             xhrFields: {withCredentials: true},
//             data: JSON.stringify({
//                 "programmeName":name,
...
//                         $.ajax({
//                             type: "POST",
//                             url: "http://47.93.98.212/Programme/UploadPlayBill/"+$id ,
//                             contentType: false,
//                             processData: false,
//                             data: data,
//                             success: function (message) {
